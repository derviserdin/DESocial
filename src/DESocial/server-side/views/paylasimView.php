...
function paylasimSonuc($id){
    ...
    while($paylasim=mysqli_fetch_assoc($dataSet)){
        ...
        echo '<div class="nav-tabs-custom paylasimAlan paylasimAlan'.$paylasim['paylasim_id'].'">
        ...
        echo '
                                            <a href="#" data-id="' . $paylasim['paylasim_id'] . '" data-toggle="modal" data-target="#silModal"  id="silPayID' . $uye[0]['user_id'] . '"" class="pull-right btn-box-tool sil"><i class="fa fa-times"></i></a>
...
function paylasimSonucDuzenle($id){
    $db=db_con();
