                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Engellenen Kullanıcı Listesi</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="example2" class="table table-bordered table-hover dataTable"
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $sql="select * from sikayet WHERE sikayet_eden_id='$user'";
                                                    ...
                                                    if($dataSet==true){
                                                        if(mysqli_num_rows($dataSet)>0){
                                                            while($row=mysqli_fetch_assoc($dataSet)){
                                                                ...
                                                                echo ' <tr role="row" class="odd paySikayetSil'.$row['sikayet_user_id'].'">

                                                                           <td>'.$sikayetEdilenUser[0]['user_adi'].'  '.$sikayetEdilenUser[0]['user_soyadi'].'</td>
                                                                           <td>
                                                                             <button data-num="'.$row['sikayet_user_id'].'"   id="paySikayetSil'.$row['sikayet_user_id'].'" type="button" class="paySikayetSil btn btn-danger">Engeli Kaldır</button>
                                                                            </td>
                                                                       </tr>';
                                                            }
                                                        }else{
                                                            echo '<h4>Şuan Hiçbir Engellenen Üye Bulunamadı</h4>';
                                                        }
                                                    }
            ...
            $.ajax(
                {
                    ...
                    success:function (gelen) {
                        if (gelen=="ok") {
                            $('.paySikayetSil'+id).remove();
                        }else{
                            alert("Bir Sorun Oluştu. Yetkili ile iletişim kurunuz.");
                        }
                    }
