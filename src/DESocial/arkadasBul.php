            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div id="duvarAlani" class="col-md-12" style="padding: 0">
                       ...
                       $query = "SELECT user_id,takip_edilen_id FROM takip where user_id='$user'";
                       ...
                       $donguSayi=1;
                       $sql="select user_id,user_profil_resim,username,user_adi,user_soyadi,user_type,user_takipci_sayi,user_takip_edilen_sayi from users  ORDER BY user_id DESC  ";
                       $dataSet=mysqli_query($db,$sql);
                       if(!$dataSet) echo mysqli_error($db);
                       while($paylasim=mysqli_fetch_assoc($dataSet)){
                           $aranacak=$paylasim['user_id'];
                           $gonderiDurum=0;
                           if($donguSayi==30) break;
                  ...
                  <!--      <ul class="list-group list-group-unbordered">
                        ...
                        <div class="islemlerUser islemlerUser<?php echo $paylasim['user_id']  ?>">
                            <?php
                            if($paylasim['user_id']!=$_SESSION['user']){
                                $takipci=$_SESSION['user'];
                                $takipEdilen=$paylasim['user_id'];
                                $sql="select user_id,takip_edilen_id from takip where user_id='$takipci' and takip_edilen_id='$takipEdilen' ";
                ...
                <!-- /.son -->
                    ...
                    <div class="col-md-12">
                        <a style="font-weight: bold" href="arkadasBul.php">Daha Fazla Takipçi Bul</a>
                    </div>
                    </div>
                    <!-- /.col -->
                </div>
